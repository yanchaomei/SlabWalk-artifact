...
def render_bytes(claims_bytes: bytes) -> bytes:
    ...
    macros: list[tuple[str, str]] = [
        ...
        ("ClaimAdvisorCellCount", f"{round(value(data, 'physical_design_advisor', 'selection_cells'))}"),
        ("ClaimAdvisorMinPercent", f"{100 * value(data, 'physical_design_advisor', 'heldout_ratio_min'):.2f}"),
        ("ClaimAdvisorGeoPercent", f"{100 * value(data, 'physical_design_advisor', 'heldout_ratio_geomean'):.2f}"),
        ("ClaimAdvisorBenefitCells", f"{round(value(data, 'physical_design_advisor', 'selected_policies', 'benefit'))}"),
        ("ClaimAdvisorIndegCells", f"{round(value(data, 'physical_design_advisor', 'selected_policies', 'indeg'))}"),
